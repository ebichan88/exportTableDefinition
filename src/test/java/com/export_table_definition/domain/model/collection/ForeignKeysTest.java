...
public class ForeignKeysTest {
    ...
    void testOfReturnsOwnForeignKeys() {
        var fk = ForeignKeyFixtures.physical("public", "orders", "unused", "fk_orders_customer", "public", "customers");
    ...
    void testIncomingOfExcludesSelfReference() {
        var selfFk = ForeignKeyFixtures.physical("public", "categories", "unused", "fk_categories_parent", "public",
                "categories");
    ...
    void testIncomingOfAcrossSchemas() {
        var fk = ForeignKeyFixtures.physical("hr", "assignment", "unused", "fk_assignment_emp", "sales", "emp");
        var foreignKeys = ForeignKeys.of(List.of(fk));
    ...
    void testGroupBySchemaRegistersBothSides() {
        var crossFk = ForeignKeyFixtures.physical("hr", "assignment", "unused", "fk_assignment_emp", "sales", "emp");
    ...
    void testCrossSchema() {
        var sameSchemaFk = ForeignKeyFixtures.physical("public", "orders", "unused", "fk_same", "public", "customers");
        var crossSchemaFk = ForeignKeyFixtures.physical("hr", "assignment", "unused", "fk_cross", "sales", "emp");
    ...
    void testIncomingOfResolvesLogical() {
        var logical = ForeignKeyFixtures.logical("public", "audit_log", "rel_audit_employee", "public", "employee");
    ...
    void testGroupBySchemaIncludesCrossSchemaLogical() {
        var logical = ForeignKeyFixtures.logical("hr", "assignment", "rel_assignment_emp", "sales", "emp");
