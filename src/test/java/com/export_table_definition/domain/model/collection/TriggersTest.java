...
public class TriggersTest {
  ...
  void testOfReturnsOwnTriggersInOrder() {
    var t1 =
        new TriggerEntity("public", "orders", "unused", "|1|trg_orders_1|BEFORE|INSERT|ROW|...|");
    var t2 =
        new TriggerEntity("public", "orders", "unused", "|2|trg_orders_2|AFTER|UPDATE|ROW|...|");
    var other =
        new TriggerEntity(
            "public", "customers", "unused", "|1|trg_customers_1|BEFORE|INSERT|ROW|...|");
