...
public class ExportTableDefinitionControllerTest {
    ...
    void testExecuteSuccessReturnsSuccessResult() {
        ...
        ResultDto result = controller.execute(List.of("public"), List.of("orders"), "output", 100, 80, List.of(),
    ...
    void testExecutePassesArgumentsThrough() {
        ...
        controller.execute(List.of("public"), List.of("orders"), "output", 100, 80, List.of("trigger", "function"),
                "conf/annotations.yml");
    ...
    void testCheckDiffNoDifferenceReturnsSuccessWithoutDifference() {
        ...
        DiffCheckResultDto result = controller.checkDiff(List.of("public"), List.of(), "output", 100, 80, List.of(),
                null);
    ...
    void testCheckDiffWithDifferenceReturnsSuccessWithDifference() {
        var usecase = new RecordingUsecase();
        usecase.diffResultToReturn = new DiffResult(List.of(Path.of("new.md")), List.of(Path.of("stale.md")),
                List.of(Path.of("changed.md")));
        var controller = new ExportTableDefinitionController(usecase);

        DiffCheckResultDto result = controller.checkDiff(List.of(), List.of(), "output", 100, 80, List.of(), null);
    ...
    void testCheckDiffPassesArgumentsThrough() {
        ...
        controller.checkDiff(List.of("public"), List.of("orders"), "output", 100, 80, List.of("trigger"),
                "conf/annotations.yml");
    ...
    void testCheckDiffExceptionReturnsFailResultWithoutPropagating() {
        ...
        DiffCheckResultDto result = assertDoesNotThrow(
