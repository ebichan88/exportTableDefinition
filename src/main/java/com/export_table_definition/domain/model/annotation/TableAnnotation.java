 ...
 * DBからリバースした情報とは別に、人間が手動で追記した「テーブル説明」「テーブル備考」
 * 「カラム備考」を保持する。テーブル定義の再生成時にこの情報をマージすることで、
 * 手書き情報が上書きで失われることを防ぐ
 *
 ...
 */
public record TableAnnotation(String description, String remarks, Map<String, String> columnRemarks) {
