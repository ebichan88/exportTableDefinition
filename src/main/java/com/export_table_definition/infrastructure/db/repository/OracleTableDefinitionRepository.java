 ...
 *
 * トリガー・関数/プロシージャ・シーケンス・ユーザー定義型（ENUM等）の出力はPostgreSQL専用のため、
 * Oracleでは空リストを返却し出力しない。
 *
 * @since 1.0
 * @version 1.0
...
public final class OracleTableDefinitionRepository extends AbstractTableDefinitionRepository {
     ...
     * {@inheritDoc}
     * <p>
     * Oracleではトリガー出力に非対応のため空リストを返却する。
     */
    @Override
     ...
     * {@inheritDoc}
     * <p>
     * Oracleでは関数・プロシージャ出力に非対応のため空リストを返却する。
     */
    @Override
     ...
     * {@inheritDoc}
     * <p>
     * Oracleではシーケンス出力に非対応のため空リストを返却する。
     */
    @Override
     ...
     * {@inheritDoc}
     * <p>
     * Oracleではユーザー定義型出力に非対応のため空リストを返却する。
     */
    @Override
